...
export const MAP_SCRIPT_OPCODES: MapScriptOpcodeDefinition[] = [
  ...
  { id: "battle", kind: "battle", title: "Start trainer battle", beginnerDescription: "Choose an opponent and prepare a trainer battle.", patterns: [/^ld\s+\[wCurOpponent\]\s*,\s*a\b/i] },
  { id: "battle-text", kind: "outcome", title: "Set battle result dialogue", beginnerDescription: "Choose the text shown after winning or losing.", patterns: [/^call\s+SaveEndBattleTextPointers\b/i] },
